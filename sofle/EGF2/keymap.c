...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    /* LEVEL4
     * ,-----------------------------------------.                    ,------------------------------------------------------------.
     * | Lorem|lenny |FLIP  |SHRUG | sleep|power |                    |  breath  | gradient|  swirl  |         |         |Velocikey|
     * |------+------+------+------+------+------|                    |----------+---------+---------+---------+---------+---------|
     * | .com | pgup |  up  | pgdn | pos1 |      |                    |   snek   |  knight |  xmas   |         |         |         |
     * |------+------+------+------+------+------|                    |----------+---------+---------+---------+---------+---------|
     * |  LV3 |  lft |  dwn |  rgt |  ende|  Mute|-------.    ,-------|  twinkle |  toggle |   HUE+  |   SAT+  |  VAL+   |   LV3   |
     * |------+------+------+------+------+------|       |    |       |----------+---------+---------+---------+---------+---------|
     * | SHIFT|      |      |      |      |      |-------|    |-------|          |   MODE  |   HUE-  |   SAT-  |  VAL-   |   LV2   |
     * `-----------------------------------------/       /     \      \------------------------------------------------------------'
     *             | nr5 | LAlt | LGUI |LCTRL | /Space  /       \Enter \  |Back  |DEL   | LV4  | nr5  |
     *             |     |      |      |      |/       /         \      \ |      |      |      |      |
     *             `----------------------------------'           '------''---------------------------'
     */
    [_LEVEL4] = LAYOUT(
        P_LOREM, LENNYF,  FLIP,    SHRUG,    KC_SLEP, KC_PWR,                    RGB_M_B,  RGB_M_G, RGB_M_SW, XXXXXXX, XXXXXXX, VK_TOGG,
        DCOM,    KC_PGUP, KC_UP,   KC_PGDN,  KC_HOME, XXXXXXX,                   RGB_M_SN, RGB_M_K, RGB_M_X,  XXXXXXX, XXXXXXX, XXXXXXX,
        KC_TRNS, KC_LEFT, KC_DOWN, KC_RIGHT, KC_END,  KC_KB_MUTE,                RGB_M_TW, RGB_TOG, RGB_HUI,  RGB_SAI, RGB_VAI, KC_TRNS,
...
/* Assign custom lighgings for the layers*/
