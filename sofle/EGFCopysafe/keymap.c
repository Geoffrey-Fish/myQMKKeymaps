...
//matrix effect declarations
enum rgb_matrix_effects {
    RGB_MATRIX_NONE = 0,
     RGB_MATRIX_SOLID_COLOR = 1,     // Static single hue, no speed support
//     RGB_MATRIX_ALPHAS_MODS,         // Static dual hue, speed is hue for secondary hue
     RGB_MATRIX_GRADIENT_UP_DOWN,    // Static gradient top to bottom, speed controls how much gradient changes
//     RGB_MATRIX_GRADIENT_LEFT_RIGHT,    // Static gradient left to right, speed controls how much gradient change
...
/*  ////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    [_vou] = LAYOUT(
        ...
        KC_PGDN, KC_LALT, KC_LGUI, KC_LCTL, KC_SPC,                                 TD(TD_ENT_SPC), KC_BSPC, KC_DEL, MO(_LEVEL4), KC_PGUP
    ),
    /* VOU
     * ,-----------------------------------------.                    ,-----------------------------------------.
     * |   ̌Uhr|   °  |   §  |   ℓ  |   »  |  «   |                    |   $  |   €  |   „  |   ”  |  “   |  ß   |
    ...
    /* LEVEL4
     * ,-----------------------------------------.                    ,-----------------------------------------.
     * | Lorem|lenny |FLIP  |SHRUG |      |      |                    |  snek|knight| xmas |      |sleep |power |
     * |------+------+------+------+------+------|                    |------+------+------+------+------+------|
     * | .com | pgup |  up  | pgdn | pos1 |      |                    |breath|swirl | twin |      |      |      |
     * |------+------+------+------+------+------|                    |------+------+------+------+------+------|
     * |  LV3 |  lft |  dwn |  rgt |  ende|      |-------.    ,-------|      |RGB ON| HUE+ | SAT+ | VAL+ |  LV3 |
     * |------+------+------+------+------+------|       |    |       |------+------+------+------+------+------|
     ...
     */
    [_LEVEL4] = LAYOUT(
        P_LOREM, LENNYF,  FLIP,    SHRUG,    XXXXXXX, XXXXXXX,                  RGB_M_SN,   RGB_M_K,  RGB_M_X,  XXXXXXX, KC_SLEP, KC_PWR,
        DCOM,    KC_PGUP, KC_UP,   KC_PGDN,  KC_HOME, XXXXXXX,                  RGB_M_B,    RGB_M_SW, RGB_M_TW, XXXXXXX, XXXXXXX, XXXXXXX,
        KC_TRNS, KC_LEFT, KC_DOWN, KC_RIGHT, KC_END,  XXXXXXX,                  RGB_MATRIX_TYPING_HEATMAP,    RGB_TOG,  RGB_HUI,  RGB_SAI, RGB_VAI, KC_TRNS, 
        KC_TRNS, XXXXXXX, XXXXXXX, XXXXXXX,  XXXXXXX, XXXXXXX, KC_NO,  KC_TRNS, KC_KB_MUTE, RGB_MOD,  RGB_HUD,  RGB_SAD, RGB_VAD, KC_TRNS,
        KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,                            KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS
    ),
...
char layer_state_str[58];// war mal 70
...
qk_tap_dance_action_t tap_dance_actions[] = {
    ...
    [TD_TIC_ESC] = ACTION_TAP_DANCE_DOUBLE(DE_CIRC, KC_ESC) // ^^ or ESC
};
